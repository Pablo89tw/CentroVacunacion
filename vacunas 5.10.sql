...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 05-10-2023 a las 13:49:13
...
INSERT INTO `ciudadano` (`idCiudadano`, `DNI`, `apellido`, `nombre`, `direccion`, `email`, `celular`, `ambitoTrabajo`, `dosisAplicadas`, `fechaProxCita`) VALUES
(19, 34585965, 'Falopa', 'Treinta', 0x, 'manarata', 64532165, 'Arte y Entretenimien', 0, '0000-00-00');
...
--
ALTER TABLE `ciudadano`
  MODIFY `idCiudadano` tinyint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
...
--
ALTER TABLE `vacunatorio`
  ADD CONSTRAINT `vacunatorio_ibfk_1` FOREIGN KEY (`idVial`) REFERENCES `viales` (`idVial`);
