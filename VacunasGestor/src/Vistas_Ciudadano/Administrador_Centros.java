...
if (jRadioButton5.isSelected()){
    ...
    private void jRadioButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jRadioButton1ActionPerformed
     if (jRadioButton4.isSelected()){   
          // listarTurnos("Ausentes",jComboBox1.getSelectedItem());
     }
...
private void  listarTurnos(String codigo_estadoCita, Vacunatorio vacunatorio){
    for (Turno turno : tD.listar_Turnos(LocalDate.now().plusDays(30),vac, codigo_estadoCita)) {
