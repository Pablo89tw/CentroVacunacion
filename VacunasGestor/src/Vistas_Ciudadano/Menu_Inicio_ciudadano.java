...
public class Menu_Inicio_ciudadano extends javax.swing.JFrame {

    private ArrayList<LogIN> logIN = new ArrayList();
    LoginData iN = new LoginData();
    public Menu_Inicio_ciudadano() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        pantalla_principal.setLayer(jButton2, javax.swing.JLayeredPane.DEFAULT_LAYER);
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(pantalla_principal, 742, 742, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Menu_Inicio_ciudadano().setVisible(true);
            }
        });
    }
